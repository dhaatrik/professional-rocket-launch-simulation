...
export class FullStack extends Vessel {
    ...
    protected override drawParts(ctx: CanvasRenderingContext2D): void {
        ...
        this.drawPayloadSection(ctx);
        this.drawUpperStageTank(ctx);
        this.drawBoosterTank(ctx);
        this.drawGridFins(ctx);
        this.drawBoosterSkirt(ctx);
        this.drawEngineCluster(ctx);
    }

    private drawNoseCone(ctx: CanvasRenderingContext2D): void {
    ...
    private drawPayloadSection(ctx: CanvasRenderingContext2D): void {
    ...
    private drawUpperStageTank(ctx: CanvasRenderingContext2D): void {
    ...
    private drawBoosterTank(ctx: CanvasRenderingContext2D): void {
    ...
    private drawGridFins(ctx: CanvasRenderingContext2D): void {
        ctx.save();
    ...
    private drawBoosterSkirt(ctx: CanvasRenderingContext2D): void {
        ctx.fillStyle = '#2c3e50';
        ctx.beginPath();
        ctx.moveTo(-18, 149);
        ctx.lineTo(-20, 155);
    ...
    private drawEngineCluster(ctx: CanvasRenderingContext2D): void {
        ctx.save();
        ctx.translate(0, 155);
...
export class Booster extends Vessel {
    ...
    protected override drawParts(ctx: CanvasRenderingContext2D): void {
        ...
        this.drawBoosterBody(ctx);
        this.drawBoosterGridFins(ctx);
        this.drawSkirt(ctx);
        this.drawLandingLegs(ctx);
        this.drawEngine(ctx);
    }

    private drawBoosterBody(ctx: CanvasRenderingContext2D): void {
    ...
    private drawBoosterGridFins(ctx: CanvasRenderingContext2D): void {
        ctx.save();
        ctx.strokeStyle = '#2c3e50';
        ctx.lineWidth = 1;
    ...
    private drawSkirt(ctx: CanvasRenderingContext2D): void {
        ctx.fillStyle = '#2c3e50';
        ctx.beginPath();
        ctx.moveTo(-18, 85);
        ctx.lineTo(-20, 90);
    ...
    private drawLandingLegs(ctx: CanvasRenderingContext2D): void {
        const alt = (state.groundY - this.y - this.h) / PIXELS_PER_METER;
        if (alt < 200) {
    ...
    private drawEngine(ctx: CanvasRenderingContext2D): void {
        ctx.save();
        ctx.translate(0, 90);
        ctx.rotate(this.gimbalAngle);
...
export class UpperStage extends Vessel {
    ...
    protected override drawParts(ctx: CanvasRenderingContext2D): void {
        ...
        this.drawFairingOrPayload(ctx);
        this.drawTank(ctx);
        this.drawVacuumEngine(ctx);
    }

    private drawFairingOrPayload(ctx: CanvasRenderingContext2D): void {
    ...
    private drawVacuumEngine(ctx: CanvasRenderingContext2D): void {
        ctx.save();
        ctx.translate(0, 50);
        ctx.rotate(this.gimbalAngle);
...
export class Payload extends Vessel {
    ...
    protected override drawParts(ctx: CanvasRenderingContext2D): void {
        this.drawSatelliteBus(ctx);
        this.drawSolarPanels(ctx);
    }

    private drawSatelliteBus(ctx: CanvasRenderingContext2D): void {
    ...
    private drawSolarPanels(ctx: CanvasRenderingContext2D): void {
