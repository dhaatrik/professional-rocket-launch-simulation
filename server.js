...
function getClientIp(req) {
    ...
    const trustArray = ['loopback', ...trustedProxies];

    // Fallback to basic socket remote address if headers are malformed for proxy-addr
    try {
        const ip = proxyaddr(req, trustArray);
